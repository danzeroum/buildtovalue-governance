...
## [7.2.0] - 2024-11-15 (Internal Release)
...
- **Minor (7.X.0):** New features, backwards compatible
- **Patch (7.3.X):** Bug fixes, security patches
...
NEW (7.3.0) - Add environment parameter
...
### v7.3.0
- **Deprecated:** Single-tenant mode (removed in v8.0)
...
- **BuildToValue Community** - 42 contributors
